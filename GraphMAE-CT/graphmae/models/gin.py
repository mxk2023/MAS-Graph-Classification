...
class GIN(nn.Module):
    def __init__(self,
        ...
        if num_layers == 1:
            apply_func = MLP(2, in_dim, num_hidden, num_hidden, activation=activation, norm=norm)
            if last_norm:
            ...
            # output projection
            apply_func = MLP(2, num_hidden, num_hidden, num_hidden, activation=activation, norm=norm)
            if last_norm:
