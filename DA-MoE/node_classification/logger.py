...
class Logger(object):
    ...
    def print_statistics(self,dataset,task_type,epochs,path,model_type,gate_model,num_layers,min_layers,seed_start,hidden_dim,dropout,coef,topK,seed=None,run=None):
        ...
        if (seed is not None) and (run is not None):
            ...
            print(f'Seed {seed_start+seed:02d} ,Run {run + 1:02d}:')
            ...
            summary_1_total = ' Seed={},Dataset={}, model_type={},gate_model={},epochs={},num_layers={},min_layers={},hidden_dim={},dropout={},topK={},coef={}'.format(
                     seed_start+seed,dataset,model_type,gate_model,epochs,num_layers,min_layers,hidden_dim,dropout,topK,coef)
            ...
            print(f'Seed {seed_start+seed + 1:02d}:')
            r = best_result[:, 0]
